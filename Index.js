...
const port = 3500; // You can choose any port you prefer
...
app.post('/api', async (req, res) => {
  try {
    ...
    // Fetch data from the YouTube Data API for the video
    ...
    // Get the video's uploaded date from the snippet
    ...
    const earnings = calculateEarnings(subscriberCount, likes, comments, views).toLocaleString();
